...
/** Read starrocks in a batch mode. */
public class StarRocksSourceBeBatchReader implements Closeable {
    ...
    public StarRocksSourceBeBatchReader(String beNodeInfo, List<ColunmRichInfo> colunmRichInfos, SelectColumn[] selectColumns,
    ...
    public StarRocksSourceFlinkRows getNextBatch() {
    ...
    private StarRocksSourceFlinkRows handleResult(TScanBatchResult result) {
        StarRocksSourceFlinkRows flinkRows;
        try {
