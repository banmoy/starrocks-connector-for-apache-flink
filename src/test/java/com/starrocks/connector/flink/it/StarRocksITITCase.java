...
public class StarRocksITITCase extends StarRocksITTestBase {
...
//                "INSERT INTO " + String.join(".", DB_NAME, options.getTableName()) + " " +
//                "WITH LABEL starrocks_source_test VALUES" +
//                "('2022-09-01', '2022-09-01 21:28:30', 'c11', 'vc11', 0, 125, -32000, 600000, 9232322, 1.2, 2.23, 83.293)," +
//                "('2022-09-02', '2022-09-02 05:12:32', 'c12', 'vc12', 1, 3, 948, 93, -12, 43.334, -9494.2, 838.23223);";
//        STARROCKS_CLUSTER.executeMysqlCommand(inserIntoData);
//
//
//        StreamExecutionEnvironment env = StreamExecutionEnvironment.getExecutionEnvironment();
...
//        StarRocksSinkOptions sinkOptions = StarRocksSinkOptions.builder()
//                .withProperty("jdbc-url", STARROCKS_CLUSTER.getJdbcUrl())
//                .withProperty("load-url", STARROCKS_CLUSTER.getLoadUrl())
//                .withProperty("database-name", DB_NAME)
//                .withProperty("table-name", "sink_table")
//                .withProperty("username", "root")
//                .withProperty("password", "")
