...
public class DefaultFeHttpService implements FeHttpService, Closeable {
    ...
    public void start() throws Exception {
        ...
        httpClient = HttpClients.custom()
                ...
                .build();
        LOG.info("Init http client, maxConnectionsPerRoute: {}, totalMaxConnections: {}, candidate hosts: {}",
                config.maxConnectionsPerRoute, totalMaxConnections, config.candidateHosts);
    }
