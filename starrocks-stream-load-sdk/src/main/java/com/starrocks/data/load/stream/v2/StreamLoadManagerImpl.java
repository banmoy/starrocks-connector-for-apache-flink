 ...
 */
public class StreamLoadManagerImpl implements StreamLoadManager, Serializable {

    private static final Logger LOG = LoggerFactory.getLogger(StreamLoadManagerImpl.class);
    ...
    public StreamLoadManagerImpl(StreamLoadProperties properties, boolean enableAutoCommit) {
    ...
    public void close() {
        if (state.compareAndSet(State.ACTIVE, State.INACTIVE)) {
            LOG.info("StreamLoadManagerImpl close, loadMetrics: {}, flushAndCommit: {}",
